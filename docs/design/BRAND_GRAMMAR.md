...
- every published win rate has an accessible sample size; Games matchups show rest advantage without historical win rates (D-57);
...
| Sample sizes are available with the analysis | Model Results and Behind the Data (D-57) |
