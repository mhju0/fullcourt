...
**Matchup reading (D-57).** Games shows rest advantage, schedule context, and the expanded
fatigue breakdown. Historical win rates and sample sizes live in Model Results; methodology
lives in Behind the Data. The page-level method link remains, with no repeated matchup links.
