...
export function WinTotalMarketCheck() {
  return (
    <div style={termCardStyle}>
      ...
      <p style={{ marginTop: SPACE.sm, maxWidth: WIDTH.prose, fontSize: TYPE.body, color: "var(--term-text)", lineHeight: 1.55 }}>
      ...
      <p style={{ marginTop: SPACE.md, maxWidth: WIDTH.prose, fontSize: TYPE.body, color: "var(--term-text-muted)", lineHeight: 1.55 }}>
