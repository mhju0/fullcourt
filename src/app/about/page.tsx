 ...
 * product rather than being one of its product surfaces. (No count here — the set has grown
 * twice since this comment was written, and a number in a comment is a second copy of a fact
 * that nothing checks.)
 *
