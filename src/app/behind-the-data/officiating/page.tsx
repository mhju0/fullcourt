...
export default function OfficiatingMethodPage() {
  return <BehindTheDataShell topic="officiating" eyebrow="BEHIND THE DATA · OFFICIATING" title="Officiating" description="How we count errors in the NBA's Last Two Minute reports.">
    <Section label="THE REVIEWED SAMPLE" title="Which games are reviewed">
      <Prose>The NBA publishes reports for games where the lead was three points or fewer at any point in the final two minutes of the fourth quarter or overtime. Reports assess calls and material non-calls. FullCourt displays regular-season reports only.</Prose>
      <Prose>We check that every report on the NBA&apos;s season index was collected. We do not independently check whether that index includes every eligible game.</Prose>
    ...
    <Section label="COUNTS AND COMPARISONS" title="What the verdicts mean">
      ...
      <Prose>Missed-call share = missed calls ÷ all identified errors. Errors per reviewed game = all identified errors ÷ reviewed games. Ungraded assessments remain available and are not counted as correct.</Prose>
